...
> Propulsé par **Claude AI (Anthropic)** pour l'OCR et l'extraction intelligente des données.
...
│  5. Analyse → Claude Opus AI        │  ← OCR + Extraction
...
├── api/
│   ├── process.js             ← Upload + Claude AI + KV
...
## 🤖 Données Extraites par Claude AI
...
| OCR + IA | Claude Opus (Anthropic) | Extraction données |
...
|---|---|---|
| PDF | OCR / IA | Vision Claude (document) |
| JPEG / PNG | OCR / IA | Vision Claude (image) |
| XML | Digital Repo | Parsing texte Claude |
...
| Claude Opus API | ~$0.015 par facture |
